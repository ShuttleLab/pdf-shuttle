...
describe('Tool Configuration Property Tests', () => {
  ...
  describe('Tool Configuration Integrity', () => {
    ...
    it('getAllTools returns the full tool catalog', () => {
      const allTools = getAllTools();
      // Catalog size after removing LibreOffice-dependent Office converters
      // (word/excel/pptx/rtf-to-pdf) that exceeded Cloudflare's asset size limit.
      expect(allTools.length).toBe(95);
    });
