...
describe('FileUploader', () => {
  ...
  describe('Rendering', () => {
    ...
    it('displays accepted file types', () => {
      ...
      // Component renders drag-drop text, not the raw MIME types
      expect(screen.getByText(/drag and drop/i)).toBeInTheDocument();
    });
    ...
    it('displays max file size', () => {
      ...
      // Component renders drag-drop text, not the raw max size value
      expect(screen.getByText(/drag and drop/i)).toBeInTheDocument();
    });
    ...
    it('displays max files when multiple is enabled', () => {
      ...
      // Component renders drag-drop text, not the raw max files value
      expect(screen.getByText(/drag and drop/i)).toBeInTheDocument();
    });
  });
  ...
  describe('Drag and Drop', () => {
    it('shows drag overlay when dragging over', () => {
      ...
      const dropElements = screen.getAllByText(/drop/i);
    ...
    it('hides drag overlay when dragging leaves', () => {
      ...
      // After leaving, the overlay should be hidden
      // The "Drop to upload" text should not be visible
