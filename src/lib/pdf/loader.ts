...
export function configurePdfjsWorker(pdfjsLib: PDFJSModule): void {
  ...
  if (typeof window !== 'undefined') {
    // pdfjs-dist v4+ ships the worker as a native ES module (.mjs).
    // The .js form was generated by the upstream PDFCraft build script
    // (scripts/sync-pdfjs-workers.js) which we removed during the fork;
    // pointing directly at .mjs avoids that build dependency.
