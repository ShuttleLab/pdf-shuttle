    ...
    setTimeout(() => {
      ...
      try {
        ...
        if (iframe?.contentDocument) {
          ...
          }          // 3. Inject PDF Shuttle Enrichment Script
          const patchScript = doc.createElement('script');
          patchScript.textContent = `
            (function() {
              console.log('[PDF Shuttle Patch] Initializing annotation patches...');
              ...
              const initInterval = setInterval(() => {
                ...
                if (ext) {
                  ...
                  console.log('[PDF Shuttle Patch] pdfjsAnnotationExtensionInstance found! Setting up patches...');
                  setupCloudFix();
              ...
              function setupCloudFix() {
                ...
                document.addEventListener('dblclick', function(e) {
                  ...
                  if (activeTool === 'cloud') {
                    ...
                    if (konvaContent) {
                      console.log('[PDF Shuttle Patch] Intercepted dblclick for cloud tool, dispatching to Konva stage.');
                ...
                document.addEventListener('keydown', function(e) {
                  if (e.key === 'Enter') {
                    ...
                    if (activeTool === 'cloud') {
                      const konvaContent = document.querySelector('.konvajs-content');
                      if (konvaContent) {
                        console.log('[PDF Shuttle Patch] Intercepted Enter key for cloud tool, dispatching dblclick to end drawing.');
                        const dblEvent = new MouseEvent('dblclick', {
                          bubbles: true,
                          cancelable: true,
                          view: window
              ...
              function setupColorPickerAndStroke() {
                ...
                if (hlColorPicker) {
                  if (!hlColorPicker.querySelector('.pdfshuttle-custom-hl-picker')) {
                    const picker = document.createElement('input');
                    picker.type = 'color';
                    picker.className = 'pdfshuttle-custom-hl-picker';
              ...
              function injectCustomMenuControls(menu) {
                if (menu.querySelector('.pdfshuttle-custom-controls')) return;

                console.log('[PDF Shuttle Patch] CustomAnnotationMenu opened, injecting custom controls...');

                const container = document.createElement('div');
                container.className = 'pdfshuttle-custom-controls';
                ...
                nativeSliders.forEach(slider => {
                  if (slider.getAttribute('min') === '1') {
                    ...
                    console.log('[PDF Shuttle Patch] Stroke width slider updated min to 0');
                  }
                });
                ...
                if (allowedFillTools.includes(selected.name)) {
                  ...
                  fillCheckbox.id = 'pdfshuttle-fill-enabled';
              ...
              function loadState(stateStr) {
                ...
                try {
                  ...
                  console.error('[PDF Shuttle Patch] Failed to load state', err);
                } finally {
                  setTimeout(() => {
              ...
              function injectUndoRedoButtons() {
                ...
                if (customToolbar) {
                  ...
                  redoLi.className = 'pdfshuttle-redo-btn';
              ...
              function updateUndoRedoButtonsState() {
                const undoBtn = document.querySelector('.pdfshuttle-undo-btn button');
                const redoBtn = document.querySelector('.pdfshuttle-redo-btn button');
          ...
          console.log('[PDF Shuttle Patch] Enrichment script successfully injected into iframe!');
        }
      } catch (e) {
